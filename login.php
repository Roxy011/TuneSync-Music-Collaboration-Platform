  	...
  	<div class="container">
  		...
  		<div id="login-center" class="row justify-content-center align-self-center w-100">
  			<div class="d-flex justify-content-center align-items-center w-100">
  				<span  class="m-4 p-2">
  				<h1 class="text-gradient-primary text-center" style="font-size: 4rem"><b><i class="fas fa-headphones-alt text-gradient-primary" onclick="location.href='Pages/Pg_Home.php'" style="cursor:pointer;" ></i></b></h1>
  				<h2 class="text-gradient-primary"><b>TuneSYNC Music Collaboration Platform.</b></h2>
  				</span>
  			</div>
